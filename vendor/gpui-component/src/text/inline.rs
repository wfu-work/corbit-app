...
impl Element for Inline {
    ...
    fn paint(
        ...
        // Resolve and paint the selection before painting glyphs. Painting the
        // background last hides the selected text whenever the selection color
        // is opaque, which is especially visible in dark themes.
...
mod tests {
    ...
    fn test_point_in_text_selection_reversed_drag_direction() {
        ...
        // Mouse down on a lower line, then drag upward. The top line follows
        // the active cursor while the bottom line keeps the anchor position.
